...
void DiffDriveGazeboRos::Load ( physics::ModelPtr _parent, sdf::ElementPtr _sdf )
{
    ...
    // {
    //   ROS_ERROR_NAMED("diff_drive", "DiffDriveGazeboRos Plugin missing <legacyMode>, defaults to true\n"
...
//       ROS_WARN_NAMED("diff_drive", "DiffDriveGazeboRos Plugin (ns = %s) missing <publishTf>, defaults to %d",
...
//     rot_ = 0;
    ...
    ROS_INFO_NAMED("diff_drive", "%s: Advertise vel on %s ", gazebo_ros_->info(), velocity_topic_.c_str());
...
// void DiffDriveGazeboRos::publishWheelJointState()
// {
...
// void DiffDriveGazeboRos::publishWheelTF()
// {
//     ros::Time current_time = ros::Time::now();
//     for ( int i = 0; i < 2; i++ ) {
...
void DiffDriveGazeboRos::UpdateChild()
{
    ...
    /* force reset SetParam("fmax") since Joint::Reset reset MaxForce to zero at
       ...
       and Joint::Reset is called after ModelPlugin::Reset, so we need to set maxForce to wheel_torque other than DiffDriveGazeboRos::Reset
...
// void DiffDriveGazeboRos::getWheelVelocities()
// {
...
// void DiffDriveGazeboRos::cmdVelCallback ( const geometry_msgs::Twist::ConstPtr& cmd_msg )
// {
//     boost::mutex::scoped_lock scoped_lock ( lock );
//     x_ = cmd_msg->linear.x;
...
// void DiffDriveGazeboRos::UpdateOdometryEncoder()
// {
...
// void DiffDriveGazeboRos::publishOdometry ( double step_time )
// {
